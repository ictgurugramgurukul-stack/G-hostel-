...
export async function renderStudentPage(container: HTMLElement, me: Me): Promise<void> {
  ...
  if (monthly.length > 0 && typeof Chart !== "undefined") {
    const ctx = (document.getElementById("monthly-chart") as HTMLCanvasElement).getContext("2d")!;
    new Chart(ctx, {
      type: "line",
      data: {
